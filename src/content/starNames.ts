...
export const LAST_NAMES = [
  ...
  'Solberg', 'Hagen', 'Johansen', 'Brekke', 'Fjeld', 'Myhre', 'Sæther', 'Vik', 'Aasen', 'Holm', 'Nygård',
  'Rustad', 'Tangen', 'Eide', 'Lund', 'Skogheim', 'Ødegård', 'Karlsen', 'Iversen', 'Kodebakken', 'Sprintland',
]

/** Nicknames are proper nouns and not translated. */
export const NICKNAMES = [
  'Kubernetes', 'Refaktor', 'YAML', 'Hotfix', 'Pull Request', 'Legacy', 'Standup', 'Figma', 'Terraform',
  'Kaffe', 'Git Blame', 'Monolitt', 'Microservice', 'Excel', 'Jira', 'Rubber Duck', 'Prod', 'Sprint',
]
