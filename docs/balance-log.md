...
- Første kjøring snakket botene på 60, altså alltid i «greit»-sjiktet. `sim.ts` gir nå hver bot samme ferdighet i krisesamtaler som i kundemøter. Da ble krisene netto _positive_ (690 / 789 MNOK), så gevinsten ved en god samtale (`talkGood`) er halvert. Tabellen over «håndteringsstil» er målt før denne endringen.
